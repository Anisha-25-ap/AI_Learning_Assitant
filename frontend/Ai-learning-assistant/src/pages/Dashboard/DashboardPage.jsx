            ...
            <div className="space-y-3">
              {[
                ...(DashboardData.recentActivity.documents || []).map(doc => ({
                  id: doc._id,
                  description: doc.title || doc.name,
                  timestamp: doc.lastAccessed || doc.updatedAt,
                ...
                ...(DashboardData.recentActivity.quizzes || []).map(quiz => ({
                  ...
                  timestamp: quiz.lastAttempted || quiz.updatedAt,
                  ...
                  >
                    <div className="flex-1 min-w-0 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                      <div>
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <p className="text-sm font-medium text-slate-900 truncate">
                            ...
                            <span className="text-slate-700 font-normal">{activity.description}</span>
                          </p>
                        </div>
                      ...
                      {activity.link && (
                        <a
                          href={activity.link}
                          className="sm:self-center px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition-all duration-200 whitespace-nowrap text-center"
                        >
                          View
                        </a>
                      )}
